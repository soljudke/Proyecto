...
namespace Armando2
{
    public partial class CustomMessageForm : Form
    {
        ...
        public CustomMessageForm(string estado)
        {
            ...
            {
                case "Ganaste":
                    pictureBox1.Image = System.Drawing.Image.FromFile("E:/Proyecto/IMGS/IMGS ARMANDO/feliz.png");
                    label1.Text = "¡Felicidades, ganaste!";
                    label2.Text = "¿Jugamos de nuevo?";
                    break;
                case "Perdiste":
                    pictureBox1.Image = System.Drawing.Image.FromFile("E:/Proyecto/IMGS/IMGS ARMANDO/triste.png");
